...
LIB_DST=~/.gradle/build/$BUILD_NAME/rootfw-stdlib-anycall
LIB_SRC="$LIB_PROJECT/src/main/java"
LIB_FILE="$LIB_DST/outputs/aar/rootfw-stdlib-anycall-$BUILD_TYPE.aar"
LIB_PKG="$LIB_PROJECT/releases/rootfw-stdlib-anycall-$BUILD_TYPE.aar"
DOC_DST="$LIB_PROJECT/docs/dokka"

BINTRAY_DST=~/.gradle/build/$BUILD_NAME/bintray
BINTRAY_PACKAGE="rootfw-stdlib-anycall"
BINTRAY_GROUP="com.spazedog.lib.rootfw"
